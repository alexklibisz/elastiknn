...
class Elastiknn86Codec extends Codec(Elastiknn86Codec.ELASTIKNN_86) {

  private val luceneCodec = Codec.forName(Elastiknn86Codec.LUCENE_86)
...
object Elastiknn86Codec {
  val ELASTIKNN_86 = "Elastiknn86Codec"
  val LUCENE_86 = "Lucene86"
}
