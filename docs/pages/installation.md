...
```docker
FROM docker.elastic.co/elasticsearch/elasticsearch:8.17.6
RUN elasticsearch-plugin install --batch https://github.com/alexklibisz/elastiknn/releases/download/8.17.6.0/elastiknn-8.17.6.0.zip
```
