...
```docker
FROM docker.elastic.co/elasticsearch/elasticsearch:8.17.8
RUN elasticsearch-plugin install --batch https://github.com/alexklibisz/elastiknn/releases/download/8.17.8.0/elastiknn-8.17.8.0.zip
```
