...
```docker
FROM docker.elastic.co/elasticsearch/elasticsearch:8.18.7
RUN elasticsearch-plugin install --batch https://github.com/alexklibisz/elastiknn/releases/download/8.18.7.0/elastiknn-8.18.7.0.zip
```
